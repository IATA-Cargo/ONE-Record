...
_([API-Security/examples/Piece.json](API-Security/examples/Piece.json))_
...
_([API-Security/examples/Company.json](API-Security/examples/Company.json))_
...
_([API-Security/examples/Shipment.json](API-Security/examples/Shipment_with_Piece.json))_
...
_([API-Security/examples/Piece_with_id.json](API-Security/examples/Piece_with_id.json))_
...
_([API-Security/examples/Shipment_with_Piece.embedded.json](API-Security/examples/Shipment_with_Piece.embedded.json))_
...
_([API-Security/examples/Change_example1.json](API-Security/examples/Change_example1.json))_
...
_([API-Security/examples/Change_example2.json](API-Security/examples/Change_example2.json))_
...
_([API-Security/examples/Change_example3.json](API-Security/examples/Change_example3.json))_
...
_([API-Security/examples/Change_example4.json](API-Security/examples/Change_example4.json))_
...
_([API-Security/examples/CustomsInformation.json](API-Security/examples/CustomsInformation.json))_
...
_([API-Security/examples/CustomsInformation_2.json](API-Security/examples/CustomsInformation_2.json))_
...
_([API-Security/examples/Change_example5.json](API-Security/examples/Change_example5.json))_
...
_([API-Security/examples/Change_example6.json](API-Security/examples/Change_example6.json))_
...
```
_([API-Security/examples/Error_400.json](API-Security/examples/Error_400.json))_
...
_([API-Security/examples/Change_example7.json](API-Security/examples/Change_example7.json))_
...
```
_([API-Security/examples/Error_400_example2.json](API-Security/examples/Error_400_example2.json))_
...
```
_([API-Security/examples/AuditTrail.json](API-Security/examples/AuditTrail.json))_
...
```
_([API-Security/examples/AuditTrail_example2.json](API-Security/examples/AuditTrail_example2.json))_
...
_([API-Security/examples/Piece_with_id.json](API-Security/examples/Piece_with_id.rev3.json))_
