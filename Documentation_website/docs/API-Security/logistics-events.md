...
_([API-Security/examples/LogisticsEvent.json](API-Security/examples/LogisticsEvent.json))_
...
_([API-Security/examples/Error_404.json](API-Security/examples/Error_404.json))_
...
_([API-Security/examples/LogisticsEvent_with_id.json](API-Security/examples/LogisticsEvent_with_id.json))_
...
```
_([API-Security/examples/LogisticsEvents_list.json](API-Security/examples/LogisticsEvents_list.json))_
...
```
_([API-Security/examples/LogisticsEvents_filtered_list.json](API-Security/examples/LogisticsEvents_filtered_list.json))_
...
```
_([API-Security/examples/LogisticsEvents_empty_list.json](API-Security/examples/LogisticsEvents_empty_list.json))_