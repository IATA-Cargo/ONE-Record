...
```
_([API-Security/examples/AccessDelegation_example1.json](API-Security/examples/AccessDelegation_example1.json))_
...
```
_([API-Security/examples/AccessDelegation_example2.json](API-Security/examples/AccessDelegation_example2.json))_
